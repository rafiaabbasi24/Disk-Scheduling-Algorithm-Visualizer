...
<body>
  <div class="first">
    ...
    <div class="algo py-3">
      <h1>SSTF: Shortest Seek Time First - Simulation</h1>
          ...
          <div class="new tm-timeline-description-wrap">
            <div class="tm-bg-dark tm-timeline-description">
              <div class="form-container-res" id="ifManualInput" style="display:block">
                ...
                <input id="Sequence" class="form-control" oninput="resetSstfResult()"
                  placeholder="Eg: 10, 25, 40  (Maximum input value = 199)" />
                <p></p>
                <label class="col-form-label">Enter the initial head position:</label>
                <input id="Head" class="form-control" oninput="resetSstfResult()"
      ...
      <div class="newc tm-bg-dark-light tm-timeline-description">
        ...
        <div class="sstf-output-man" id="ifManualOutput" style="display:block">
          ...
          <span style="font-weight: bolder; color: #ffffff" id="sstf_totalSeekCount"></span>
          <p></p>
          <label>Sequence of execution:&nbsp;</label>
          <span style="font-weight: bolder; color: #ffffff" id="sstf_finalOrder"></span>
          <p></p>
