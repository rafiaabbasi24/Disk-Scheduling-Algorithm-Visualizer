    ...
    <div class="algo">
            ...
            <div class="tm-bg-dark tm-timeline-description">
              <div class="">
                <div class="form-container-res" id="ifManualInput" style="display:block">
                  ...
                  <input id="Sequence" class="form-control" oninput="resetCLookResult()" placeholder="Eg: 10, 25, 40  (Maximum input value = 199)" />
                  <p></p>
                  <label class="col-form-label">Enter the initial head position:</label>
                  <input id="Head" class="form-control" oninput="resetCLookResult()" placeholder="Eg: 20 (Maximum input value = 199)" />
                  <p></p>
                  ...
                  <div class="center-run">
                    <button class="btn btn-outline-primary btn-outline-light" onclick="clook_click()" id="CLOOK">Run CLOOK</button>
                  </div>
                  <br>
                </div>
              </div>
      ...
      <div class="newc tm-bg-dark-light tm-timeline-description">
        ...
        <div class="clook-output-man" id="ifManualOutput" style="display:block">
          ...
          <span style="font-weight: bolder; color: #ffffff" id="clook_totalSeekCount"></span>
          <p></p>
          <label>Sequence of execution:&nbsp;</label>
          <span style="font-weight: bolder; color: #ffffff" id="clook_finalOrder"></span>
          <p></p>
