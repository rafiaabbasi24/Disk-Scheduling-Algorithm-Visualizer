...
<body>
  <div class="first">
    ...
    <div class="algo">
      <h1>FCFS: First Come First Serve - Simulation</h1>
            ...
            <div class="tm-bg-dark tm-timeline-description">
              <div class="">
                <div class="form-container-res" id="ifManualInput" style="display:block">
                  ...
                  <input id="Sequence" class="form-control" oninput="resetFcfsResult()"
                    placeholder="Eg: 10, 25, 40  (Maximum input value = 199)" />
                  <p></p>
                  <label class="col-form-label">Enter the initial head position:</label>
                  <input id="Head" class="form-control" oninput="resetFcfsResult()"
                    placeholder="Eg: 20 (Maximum input value = 199)" />
                  <p></p>
                  <div class="center-run">
                    <button class="btn btn-outline-primary btn-outline-light" onclick="fcfs_click()" id="FCFS">Run
                      FCFS</button>
                  </div>
                </div>
              </div>
    ...
    <div class="footer">
      <div class="container">
        <div class="row py-3 text-light">
          <div class="col-lg-3">
            <a href="../index.php"><img src="../images/footer.png" class="footer-logo img-fluid" width="200"
